...
?>
            <ul class="list-group mb-3 list-product-new">
                  <li class="list-group-item bg-secondary py-3">Sản phẩm mới</li>
                  ...
                  <li class="list-group-item">
                     <div class="product-item border">
                        ...
                        <h2 class="product-item-name text-secondary text-center fs-5 py-1">
                        ...
                        <h3 class="product-item-price fs-6 p-2 d-flex">
                           ...
                           <div class="flex-fill text-end text-secondary"><?= number_format($pro->pricesale);?>đ</div>
                        </h3>
                     </div>
                  </li>
                  <?php endforeach;?>
