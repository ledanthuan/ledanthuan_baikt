                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    ...
                                    <?php if($item->status==1):?>
                                       <a  href="index.php?option=topic&cat=status&id=<?= $item->id;?>" class="btn btn-success btn-xs" >
                                       <i class="fas fa-toggle-on"></i> Hiện</a>
                                       <?php else : ?>
                                       <a  href="index.php?option=topic&cat=status&id=<?= $item->id;?>" class="btn btn-danger btn-xs">
                                       <i class="fas fa-toggle-on"></i> Ẩn</a>
                                       <?php endif;?>
                                       <a  href="index.php?option=topic&cat=edit&id=<?= $item->id;?>" class="btn btn-warning btn-xs">
